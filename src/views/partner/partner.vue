  ...
  <div class="home">
    ...
    <div class="topcontent">
      <div class="top-main">
        ...
        <!--<div class="note">
          <div class="note-txt">
          恭喜XX成为XX城市合伙人，携手CNFS平台开启合作共赢新篇章！
        </div>
        </div>-->
      </div>
    </div>
    ...
    <div class="mind-box">
      <h3>合作理念</h3>
      <h4>
        主要从平台和市场两个层面对合作关系进行多维度的建设达到优化机制、合作共赢的效果
      </h4>
      <div class="mindcon">
    ...
    <div class="">
      ...
      <div class="mind-box">
        <h3>城市合伙人权益</h3>
        <h4>
          不断优化平台机制，让项目最大限度凸显价值，为合作伙伴创造更多收益和项目建设的机会
        </h4>
        <div class="mindcon">
          ...
          <div class="mindcon-txt">
            <h5 style="padding-top: 100px">城市合伙人权益</h5>
            <ul>
              <li>分享平台十六大利益；</li>
              <li>年收益可望上亿；</li>
      ...
      <div class="mind-box" style="padding-bottom:150px">
        ...
        <div class="mindcon">
          <div class="mindcon-txt">
            <h5 style="padding-top: 95px">战略合作条件</h5>
            <ul>
...
.home {
  ...
  .set-box {
    ...
    .setcon-list {
      width: 278px;
      height: 410px;
      background: url("~@/assets/partner/bg01.png");
      position: relative;
      margin: 36px 8px;
